...
class ScoringPolicy:
    MULTIPLIERS = {MatchLocation.HEADLINE: 5.0, MatchLocation.DESCRIPTION: 3.0, MatchLocation.FULL_TEXT: 1.0}

    @staticmethod
    def calculate_score(
        tender_title: str, tender_description: str, tender_full_text: str, keywords: List[Keyword]
    ) -> ScoringResult:
        total_score = 0.0
        title_score = 0.0
        matches = []
