...
async def test_keyword_lifecycle():
    async with httpx.AsyncClient(base_url=BASE_URL, timeout=10.0) as client:
        ...
        payload = {"term": term, "category": "sustainability", "weight": 3.5}
        ...
        update_payload = {"term": term, "category": "sustainability", "weight": 2.5}
        ...
        cat_update_payload = {"term": term, "category": "innovation", "weight": 2.5}
        ...
        rename_payload = {"term": new_term, "category": "innovation", "weight": 2.5}
