...
class LLMService:
    ...
    async def get_settings(self, provider: AIProvider) -> AIProviderSettings:
        ...
        return AIProviderSettings(provider=provider, is_active=has_env_creds, model=self._default_model_for(provider))
    ...
    async def generate_text(
        self, config: AIConnectorConfig, system_prompt: str, user_prompt: str, json_mode: bool = False
    ) -> str:
